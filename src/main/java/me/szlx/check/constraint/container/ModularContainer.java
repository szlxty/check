...
public class ModularContainer implements ConstraintContainer {
    ...
    public ModularContainer(ConstraintContainer constraintContainer) {
        ...
        if (ModularContainer.class.isAssignableFrom(constraintContainer.getClass())) {
            throw new IllegalArgumentException("初始化ModularContainer时，指定的约束容器已经是ModularContainer了");
        }
     ...
     */
    @Override
    public Constraint find(String constraintCodeOrBrief) {
